...
\begin{col}{0.8\textwidth}
	\begin{itemize}
		...
		\item I applied machine learning methods and Large Language Models on millions of websites of European companies to determine whether they use AI and if so, how they use it.
	\end{itemize}
\end{col}
\end{cols}
