...
\begin{col}{0.8\textwidth}
	\begin{itemize}
		\tightlist
		\item I work on the \href{https://www.liser.lu/education-training-upskilling}{INSKILL project}, specifically on mapping AI adoption in Europe through big data.
		\item I apply machine learning methods and Large Language Models on millions of websites of European companies to determine whether they use AI and if so, how they use it.
	\end{itemize}
\end{col}
\end{cols}
